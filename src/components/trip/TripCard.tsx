...
function TripCard({ trip }: Props) {
  ...
  return (
    <div
      ...
      className="relative flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md cursor-pointer"
    >
      ...
      <div className="mt-4 px-5 pb-3">
        <h5 className="text-xl tracking-tight text-slate-900">{trip.title}</h5>
